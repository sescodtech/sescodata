        ...
        <>
          ...
          <motion.div
            ...
            className={`fixed inset-x-0 bottom-0 z-50 bg-white rounded-t-2xl shadow-2xl max-h-[85vh] flex flex-col
                       sm:inset-y-0 sm:left-auto sm:right-0 sm:top-0 sm:bottom-0 sm:w-full ${wide ? 'sm:max-w-2xl' : 'sm:max-w-md'} sm:rounded-t-none sm:rounded-l-2xl sm:max-h-none`}
          >
            <div className="flex items-center justify-between px-4 sm:px-5 py-3 border-b border-gray-100 shrink-0">
              <h3 className="font-bold text-[15px] text-gray-900 font-display">{title}</h3>
