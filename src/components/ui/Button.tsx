...
const VARIANT_CLASSES: Record<Variant, string> = {
  ...
  ghost: 'shb-btn-ghost',
  danger: 'bg-red-500 text-white font-bold rounded-lg hover:bg-red-600 active:scale-[0.98] transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed',
};
